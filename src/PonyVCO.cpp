...
struct PonyVCOWidget : ModuleWidget {
	PonyVCOWidget(PonyVCO* module) {
        ...
        // Minimal generic UI: keep ALL params as knobs and all jacks, arranged in 3 columns
        addParam(createParamCentered<RoundHugeBlackKnob>(mm2px(Vec(6.0, 22.0)), module, PonyVCO::FREQ_PARAM));
        addParam(createParamCentered<RoundLargeBlackKnob>(mm2px(Vec(15.0, 22.0)), module, PonyVCO::TIMBRE_PARAM));
        addParam(createParamCentered<RoundSmallBlackKnob>(mm2px(Vec(5.0, 44.0)), module, PonyVCO::RANGE_PARAM));
        addParam(createParamCentered<RoundSmallBlackKnob>(mm2px(Vec(10.0, 44.0)), module, PonyVCO::OCT_PARAM));
        addParam(createParamCentered<RoundSmallBlackKnob>(mm2px(Vec(15.0, 44.0)), module, PonyVCO::WAVE_PARAM));

        // Inputs in two rows of three
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(5.0, 90.0)), module, PonyVCO::TZFM_INPUT));
        addInput(createInputCentered<PJ301MPort>(mm2px(Vec(10.0, 90.0)), module, PonyVCO::TIMBRE_INPUT));
